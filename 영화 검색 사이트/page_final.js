document.addEventListener('DOMContentLoaded', async () => {
    ...
    const createMoviecard = movie => {
        ...
        image.src = poster_path ? `https://image.tmdb.org/t/p/w500${poster_path}` : '이미지 없음';
        // 값 설정
    ...
    const options = {
        ...
        headers: {
            ...
            Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhYmQ0YTRiZjc4MWI1YTA4MTdlMjRhZmUzNjRiZWNhMCIsInN1YiI6IjY2MmIzNTc2NzY0ODQxMDExZTJjM2U2MiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.5pdEmFDv2ba8pnOTwdwumfzbukzsR3Kwe33j2nNjnXI'
        }
    };
